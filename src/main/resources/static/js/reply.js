 ...
 */
 'use strict';
	...
	let $boardForm__modiReplyTextarea;
	...
	const modiTextbox_f = e => {
		...
		$boardForm__modiReplyTextarea = document.createElement("div");
		
		//댓글수정 textbox생성
		let html = `<div id="boardForm__modiReplyWrap">`;
				html +=`	<textarea name="rcontent" cols="30" rows="3" id="boardForm__modiReplyTextarea" style="resize: none;"></textarea>`;
		...
		document.querySelector("textarea[name=rcontent]").textContent=$boardForm__ReplyContent.textContent;
